      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-3">Mobile Ready for use</h3>
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold text-lg mb-3">General Election 2026</h4>
              <div className="space-y-2 text-gray-600">
                <p className="flex items-center">
                  <span className="w-5 h-5 text-primary-500 mr-2">📅</span>
                  Voting Period: May 1-15, 2026
                </p>
              
                <p className="flex items-center">
                  <span className="w-5 h-5 text-primary-500 mr-2">👨‍💼</span>
                  <span data-testid="text-total-candidates">{totalCandidates} Candidates</span>
                </p>
                <p className="flex items-center">
                  <span className="w-5 h-5 text-primary-500 mr-2">🗳️</span>
                  <span data-testid="text-votes-cast">{totalVotes} Votes Cast</span>
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    <span>Turnout</span>
                    <span data-testid="text-turnout">{turnoutPercentage}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-secondary-500 h-2 rounded-full" style={{width: `${turnoutPercentage}%`}}></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 text-sm text-gray-400">
              ...
              <span><Smartphone className="w-4 h-4 inline mr-1" /> Mobile Friendly & Easy to use</span>
            </div>
          </div>
        </div>
      </footer>
